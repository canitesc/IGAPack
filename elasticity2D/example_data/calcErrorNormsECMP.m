function  [l2relerr, h1relerr]=calcErrorNormsECMP( sol0, PHTelem, GIFTmesh, p, q, Cmat, force, E, nu, stressState)
        ...
        if isempty(PHTelem{patchIndex}(i).children)
            ...
            for jj=1:numGaussY
                for ii=1:numGaussX
                    ...
                    adv = xCr(2,:) - xCr(1,:);
                    xTip = [cracklength 1];
                    [disp_x, disp_y] = exact_Griffith3(coord,E,nu,stressState, Kexact1, Kexact2,xTip,adv);
                    disp_ex = [disp_x, disp_y];
                    
                    stress_ex=exact_stressesEC(r, theta, Kexact1, Kexact2);
                   % stress_ex = stress_ex';
