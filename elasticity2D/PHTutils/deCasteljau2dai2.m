function [ Ce1, Ce2, Ce3, Ce4, in1, in2, in3, in4, dimBasis ] = deCasteljau2dai2( Ce, knotU1, knotU2, knotV1, knotV2, p, q, newVert, knotUl, knotUr, knotVd, knotVu, elmIn, dimBasis )
...
%    end
    ...
    for j=1:length(newVert)
        switch newVert(j)
            case 1
                temp(1:beta+1,(p+1-alpha):p+alpha+2) =0;
            case 2
                temp((q+1-beta):q+beta+2,2*p-alpha+2:end) = 0;
            case 3
                temp(2*q-beta+2:end,p+1-alpha:p+alpha+2) = 0;
            case 4
                temp(q+1-beta:q+beta+2,1:alpha+1) = 0;
            case 5
                temp(q+1-beta:q+beta+2,p+1-alpha:p+alpha+2) = 0;
        end
    end
...
[newBasisSet, dimBasis ] = newBasisIndices( newVert, elmIn, p, q, dimBasis );
