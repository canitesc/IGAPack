function [ PHTelem, sizeBasis ] = zipConformingIso( PHTelem, dimBasis, vertex2patch, edge_list, p, q )
...
for edge_index = 1:length(edge_fields)
    ...
    nodesAcell = sortEdgeNodesElemIso( PHTelem{patchA}, edgeA, p, q, 1 );
    ...
    if length(edge_list.(edge_field))==5
        ...
        nodesBcell = sortEdgeNodesElemIso( PHTelem{patchB}, edgeB, p, q, flagDir);
