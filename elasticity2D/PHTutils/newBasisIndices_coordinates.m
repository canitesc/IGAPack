function [newBasisSet, dimBasis, newBasisIndex ] = newBasisIndices_coordinates( newBasisVert, elmIn, p, q, dimBasis )
%returns the entries of element nod after adding new basis vertices
%outputs the global indices for the new basis functions 
%works only for p=q=3
...
newBasisIndex = zeros(5,4);
%each row in the newBasisIndex array corresponds to a location for each new
%basis vertex. The entries are the global indices.
...
for j=1:length(newBasisVert)
    switch newBasisVert(j)
        case 1                     
            ...
            newBasisIndex(1,:) = basisCounter+1:basisCounter+(alpha+1)^2;
        ...
        case 2
            ...
            newBasisIndex(2,:) = basisCounter+1:basisCounter+(alpha+1)^2;
        ...
        case 3
            ...
            newBasisIndex(3,:) = basisCounter+1:basisCounter+(alpha+1)^2;
        ...
        case 4
            ...
            newBasisIndex(4,:) = basisCounter+1:basisCounter+(alpha+1)^2;
        ...
        case 5
            ...
            newBasisIndex(5,:) = basisCounter+1:basisCounter+(alpha+1)^2;
