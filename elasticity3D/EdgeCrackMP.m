%script EdgeCrackMP.m
% implement a cracked domain with PHT splines
% Asymptotic Mode I with exact solution
% use Multipatch
% use GIFT mapping
...
while keep_refining
    ...
    [ stiff, rhs, bcdof, bcval ] = imposeNeuDirichletMICrMP(stiff, rhs, PHTelem, GIFTmesh, p, q, r, force);
    ...
    toc
    vtuFile = ['EdgeCrackSol',num2str(num_steps),'.vtu'];
    ...
    [l2relerr, h1relerr] = calcErrorNormsECMP( sol0, PHTelem, GIFTmesh, p, q, r, Cmat, force, E0, nu0, stressState);
    l2relerr
    h1relerr
