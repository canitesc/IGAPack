%script ElasticCrackM2MP.m
% implement a cracked domain with PHT splines
% model mode II like deformation
% use Multipatch
% use GIFT mapping
...
while keep_refining
    ...
    [ stiff, rhs, bcdof, bcval ] = imposeDirichletECrM2MP(stiff, rhs, PHTelem, p, q, r, bound_disp);
    ...
    toc
    vtuFile = ['ElasticCrackM2Sol',num2str(num_steps),'.vtu'];
