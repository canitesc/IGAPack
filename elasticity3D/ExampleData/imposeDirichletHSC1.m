function [ stiff, rhs, bcdof, bcval ] = imposeDirichletHSC1(stiff, rhs, PHTelem, p, q, r, bound_disp)
%impose Dirichlet boundary conditions for the C^1 elastic horseshoe
...
bcval_left_x = -bound_disp*ones(size(bcdof_left_x));
