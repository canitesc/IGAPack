function [ stiff, rhs, bcdof, bcval ] = imposeNeuDirichletM3CrMP(stiff, rhs, PHTelem, GIFTmesh, p, q, r, KIII)
...
bcdof = [bcdof_URR_z, bcdof_URO_x, bcdof_URO_y];
bcval = [bcval_URR_z, bcval_URO_x, bcval_URO_y];
...
%             Kexact1 = 0;
%             Kexact2 = 0;
            stress=exact_stressesM3(rad, theta, KIII);
