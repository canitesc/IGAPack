function [ stiff, rhs, bcdof, bcval ] = imposeDirichletTBeamMP(stiff, rhs, PHTelem, p, q, r, bound_disp)
...
bcdof = [bcdof_left_x, bcdof_left_y, bcdof_left_z, bcdof_right_z];
bcval = [bcval_left_x, bcval_left_y, bcval_left_z, bcval_right_z];
