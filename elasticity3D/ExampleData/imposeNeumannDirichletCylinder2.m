...
bound_disp = 0.1;
bcdof = [bcdof_front_x, bcdof_front_y, bcdof_back_x, bcdof_back_y];
%bcval = [bcval_left_y, bcval_front_z, bcval_right_x];
bcval = [bound_disp*ones(size(bcdof_front_x)), zeros(size(bcdof_front_y)), zeros(size(bcdof_back_x)), bound_disp*ones(size(bcdof_back_y))];
% 
