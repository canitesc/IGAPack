function  [l2relerr, h1relerr]=calcErrorNormsPennyMP( sol0, PHTelem, GIFTmesh, p, q, r, E, nu, Cmat, a, sigma)
            ...
            for kk=1:numGaussZ
                for jj=1:numGaussY
                    for ii=1:numGaussX
                        ...
                        %[ stress_ex] = exact_stressesSlit( coord, crackTip1, crackTip2, a, sigma22  );
                        [ux, uy, uz, stress_ex] = exact_penny(coord, E, nu, a, sigma);
                        %stress_ex(3) = -stress_ex(3);
                        disp_ex = [ux, uy, uz];
                  %      stress_ex = zeros(6,1);
