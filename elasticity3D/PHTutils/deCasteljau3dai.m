...
newKnotV = [knotVd*ones(1,q+1), knotV1*ones(1,q-beta), knotVmid*ones(1,q-beta), knotV2*ones(1,q-beta), knotVu*ones(1, q+1)];
newKnotW = [knotWb*ones(1,r+1), knotW1*ones(1,r-gamma), knotWmid*ones(1,r-gamma), knotW2*ones(1,r-gamma), knotWt*ones(1, r+1)];
...
for i=1:size(Ce,1)
    ...
    for j=1:length(newVert)
        switch newVert(j)
            case 1
                temp(1:q-beta,(alpha+2):2*p-alpha+1,(gamma+2):2*r-gamma+1) = 0;
            case 2
                temp((beta+2):2*q-beta+1,p+alpha+2:end,(gamma+2):2*r-gamma+1) = 0;
            case 3
                temp(q+beta+2:end,(alpha+2):2*p-alpha+1,(gamma+2):2*r-gamma+1) = 0;
            case 4
                temp((beta+2):2*q-beta+1,1:p-alpha,(gamma+2):2*r-gamma+1) = 0;
            case 5
                temp((beta+2):2*q-beta+1,(alpha+2):2*p-alpha+1,1:r-gamma) = 0;
            case 6
                temp((beta+2):2*q-beta+1,(alpha+2):2*p-alpha+1,r+gamma+2:end) = 0;
            case 7
                temp((beta+2):2*q-beta+1,(alpha+2):2*p-alpha+1,(gamma+2):2*r-gamma+1) = 0;
            case 8
                temp((beta+2):2*q-beta+1,1:p-alpha,r+gamma+2:end) = 0;
            case 9
                temp((beta+2):2*q-beta+1,1:p-alpha,1:r-gamma) = 0;
            case 10
                temp((beta+2):2*q-beta+1,p+alpha+2:end,r+gamma+2:end) = 0;
            case 11
                temp((beta+2):2*q-beta+1,p+alpha+2:end,1:r-gamma) = 0;
            case 12
                temp(1:q-beta,(alpha+2):2*p-alpha+1,r+gamma+2:end) = 0;
            case 13
                temp(1:q-beta,(alpha+2):2*p-alpha+1,1:r-gamma) = 0;
            case 14
                temp(q+beta+2:end,(alpha+2):2*p-alpha+1,r+gamma+2:end) = 0;
            case 15
                temp(q+beta+2:end,(alpha+2):2*p-alpha+1,1:r-gamma) = 0;
            case 16
                temp(1:q-beta,1:p-alpha,(gamma+2):2*r-gamma+1) = 0;
            case 17
                temp(1:q-beta,p+alpha+2:end,(gamma+2):2*r-gamma+1) = 0;
            case 18
                temp(q+beta+2:end,1:p-alpha,(gamma+2):2*r-gamma+1) = 0;
            case 19
                temp(q+beta+2:end,p+alpha+2:end,(gamma+2):2*r-gamma+1) = 0;
        end
    end
