function msh_to_vtu_3dVM_20points(pts, u, stress, stressVM, npts, filename)

% MSH_TO_VTU_3DVM: Export an unstructured mesh to VTK format for plotting.
%
%  msh_to_vtu_3dVM (pts, u, stress, stressVM, npts, filename, fieldname)
%
% INPUT:
%
...
%     stressVM:  values of the von Misses stresses at the selected points
...
str7 = cat(2, '</DataArray> \n', ...
    '<DataArray  type="Float64"  Name="stressVM" NumberOfComponents="1" format="ascii"> \n');
