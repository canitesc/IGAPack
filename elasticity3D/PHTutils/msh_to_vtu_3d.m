function msh_to_vtu_3d(pts, u, stress, npts, filename)

% MSH_TO_VTU_3D: Export an unstructured mesh to VTK format for plotting.
%
%  msh_to_vtu_3d (pts, u, stress, npts, filename, fieldname)
%
% INPUT:
%
