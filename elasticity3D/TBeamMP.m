%scriptTBeamMP.m
% implement a cantilever beam as in Phu's Nitsche coupling code with PHT splines
% use Multipatch
% use GIFT mapping
...
bound_disp = 1;   %imposed displacement on the boundary
...
GIFTmesh = init3DGeometryGIFTMP('Tbeam',L,W,H,numPatches);
...
patchBoundaries = {1, 5, 2, 4; 1, 2, 3, 1; 1, 3, 6, 5; [2, 3], 4, [6, 3], [5, 1]};
...
while keep_refining
    ...
    [ stiff, rhs, bcdof, bcval ] = imposeDirichletTBeamMP(stiff, rhs, PHTelem, p, q, r, bound_disp);
