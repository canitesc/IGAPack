%script ElasticCUBEMP.m
% implement a cube domain with PHT splines
% use Multipatch
% use GIFT mapping
% if nu0=0, this is essentially a patch test with linear displacements
...
GIFTmesh = init3DGeometryGIFTMP('cube',L,W,H,numPatches);
...
while keep_refining
    ...
    [ stiff, rhs, bcdof, bcval ] = imposeDirichletECMP(stiff, rhs, PHTelem, p, q, r, bound_disp);
    ...
    toc
    vtuFile = ['ElasticCubeSol',num2str(num_steps),'.vtu'];
