...
% model mode III like deformation
% use Multipatch
% use GIFT mapping
...
while keep_refining
    ...
    [ stiff, rhs, bcdof, bcval ] = imposeDirichletECrM3MP(stiff, rhs, PHTelem, p, q, r, bound_disp);
    ...
    toc
    vtuFile = ['ElasticCrackM3Sol',num2str(num_steps),'.vtu'];
    plotStressDisp3DMP(PHTelem, GIFTmesh, sol0, p, q, r, Cmat, vtuFile)
    toc
