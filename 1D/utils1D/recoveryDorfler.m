function [estError,patchRef,estErrorGlob]=recoveryDorfler(PHTmesh,elementNodes,displacements,target_rel_error,patchList,C)
...
for j=1:size(patchList,1)
    i = patchList(j,1); %pick the first elements
